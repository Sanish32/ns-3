...
## Note: 
This readme file does not explain what each step means and what is its point. It only provides the necessary steps to run the ns-3 C++ code to generate test data for simplicity
.
